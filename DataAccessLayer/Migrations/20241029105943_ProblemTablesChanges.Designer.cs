...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20241029105943_ProblemTablesChanges")]
    partial class ProblemTablesChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.AppointmentSolutionModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppointmentSolutionRecord");
                });
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.ProblemSolutionModel", b =>
                {
                    ...
                    b.Property<int>("AppointmentSolutionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AppointmentSolutionId");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.AppointmentSolutionModel", b =>
                {
                    b.HasOne("ModelAccessLayer.Models.AppointmentModel", "Appointment")
                        ...
                        .HasForeignKey("ModelAccessLayer.Models.AppointmentSolutionModel", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ModelAccessLayer.Models.JyotishModel", "Jyotish")
                        .WithMany("AppointmentSolutionRecord")
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.ProblemSolutionModel", b =>
                {
                    b.HasOne("ModelAccessLayer.Models.AppointmentSolutionModel", "AppointmentSolution")
                        .WithMany("Solution")
                        .HasForeignKey("AppointmentSolutionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppointmentSolution");
                });
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.JyotishModel", b =>
                {
                    b.Navigation("AppointmentSolutionRecord");
