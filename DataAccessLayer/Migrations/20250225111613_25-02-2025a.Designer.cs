...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20250225111613_25-02-2025a")]
    partial class _25022025a
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.ActiveMail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.AdminVideos", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.AppointmentBookmarkModal", b =>
                {
                    ...
                    b.ToTable("AppointmentBookmark");
                });

            modelBuilder.Entity("ModelAccessLayer.Models.AppointmentChargesManagement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppointmentChargesManagement");
                });
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.ContactUs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.JyotishChargeManagement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("JyotishChargeManagement");
                });
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.JyotishPoojaModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.KundaliMatchingModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("KundaliMatchingRecord");
                });
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.PrivacyPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.PurchaseAdvertisement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AdvertisementArea")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.TimezoneModal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.EmployeeInterviewAttachmentModel", b =>
                {
                    b.HasOne("ModelAccessLayer.Models.EmployeeInterviewFeedbackModel", "EmployeeIF")
                        .WithMany("EmployeeInterviewAttachment")
                        .HasForeignKey("EmployeeIFId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EmployeeIF");
                });

            modelBuilder.Entity("ModelAccessLayer.Models.EmployeeInterviewFeedbackModel", b =>
                {
                    b.HasOne("ModelAccessLayer.Models.Employees", "Employee")
                        .WithMany("EmployeeInterviewFeedbacks")
                        .HasForeignKey("EmployeeId");

                    b.HasOne("ModelAccessLayer.Models.SlotBookingModel", "SlotBooking")
                        .WithMany("EmployeeInterviewFeedbacks")
                        .HasForeignKey("SlotBookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.InterviewFeedbackModel", b =>
                {
                    ...
                    b.HasOne("ModelAccessLayer.Models.JyotishModel", "Jyotish")
                        .WithMany("InterviewFeedbackModel")
                        .HasForeignKey("JyotishId");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.PurchaseAdvertisement", b =>
                {
                    b.HasOne("ModelAccessLayer.Models.AdvertisementPackage", "advertisement")
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.RedeemCodeRequest", b =>
                {
                    ...
                    b.HasOne("ModelAccessLayer.Models.SubscriptionModel", "plan")
                        .WithMany("redeemRequest")
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.levelsAccessValidation", b =>
                {
                    ...
                    b.HasOne("ModelAccessLayer.Models.EmployeesAccessPages", "EmpPages")
                        .WithMany("LevelAccess")
                        .HasForeignKey("pages")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.AppointmentModel", b =>
                {
                    b.Navigation("AppointmentBookmark");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.EmployeeInterviewFeedbackModel", b =>
                {
                    b.Navigation("EmployeeInterviewAttachment");
                });

            modelBuilder.Entity("ModelAccessLayer.Models.Employees", b =>
                {
                    b.Navigation("EmployeeInterviewFeedbacks");
            ...
            modelBuilder.Entity("ModelAccessLayer.Models.JyotishModel", b =>
                {
                    ...
                    b.Navigation("InterviewFeedbackModel");
                    ...
                    b.Navigation("UserServiceRecord");

                    b.Navigation("bookedPooja");

                    b.Navigation("clientMembers");

                    b.Navigation("jyotishCharges");
